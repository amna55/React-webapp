...
function Button3() {
  ...
  const navigateToFirstPage = () => {
    navigate('/'); // Adjust '/firstPage' to your actual route
  };

  // Function to navigate to the second page
  const navigateToSecondPage = () => {
    navigate('/HecHms'); // Adjust '/secondPage' to your actual route
  };

  return (
    <div className="action-buttons">
      <button onClick={navigateToFirstPage} className="go-first-page-button">Home</button>
